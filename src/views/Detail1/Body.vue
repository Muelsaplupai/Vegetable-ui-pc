<template>
  <el-container>
    <!-- 侧边栏 -->
    <el-aside>
      <button class="el-selection" @click="goToComponent('search')">
        <img src="@/assets/logo1.png" class="sleimg" />
        <div class="sletext">数据查询</div>
      </button>
      <button class="el-selection" @click="goToComponent('analysis')">
        <img src="@/assets/logo2.png" class="sleimg" />
        <div class="sletext">预测分析</div>
      </button>
      <button class="el-selection" @click="goToComponent('news')">
